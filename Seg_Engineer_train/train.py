...
# train one epoch
def train(segmentation_module, iterator, optimizer, history, epoch, cfg):
    ...
    for i in range(cfg.TRAIN.epoch_iters):
        ...
        if i == 0 or i % cfg.TRAIN.disp_iter == 0:
            print('[Train]: Epoch: [{}][{}/{}], Time: {:.2f}, '
                  'lr: {:.6f}, Accuracy: {:4.2f}, Loss: {:.6f}'
                  .format(epoch, i, cfg.TRAIN.epoch_iters,
                          batch_time.average(), cfg.TRAIN.running_lr,
...
def checkpoint(nets, history, cfg, epoch):
    ...
    torch.save(
        dict_net,
        '{}/seg_epoch_{}.pth'.format(cfg.DIR, epoch))
...
def main(cfg, gpus):
    ...
    seg_net = ModelBuilder.build_net(
        encoder_weights=cfg.MODEL.weights_encoder,
        decoder_weights=cfg.MODEL.weights_decoder,
